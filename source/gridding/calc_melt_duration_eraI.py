""" calc_melt_duration_erai.py
	...
	Input: ERAI 2m air temperatures
	Output: Gridded ERAI melt duration
	...
	Update history:
		...
		09/2020: adapted for ERAI from ERA5 script
"""
...
def main(yearT, startMonth=0, endMonth=11, extraStr='v11', dx=50000, data_path=reanalysis_raw_path+'ERAI/', out_path=forcing_save_path+'Temp/ERAI/', fig_path=figure_path+'Temp/ERAI/', anc_data_path='../../anc_data/'):
	...
	xptsM, yptsM, temp2mYear =get_ERAI_temps(proj, data_path, yearT)
