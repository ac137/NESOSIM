...
def main(yearT, startMonth=0, endMonth=11, extraStr='v11', dx=100000, data_path=reanalysis_raw_path+'ERA/', out_path=forcing_save_path+'Temp/ERA5/', fig_path=figure_path+'Temp/ERA5/', anc_data_path='../../anc_data/'):
